...
class BasicBlock(nn.Module):
    ...
    def __init__(self, builder, in_planes, planes, channels_1, channels_2=None, stride=1):
        super(BasicBlock, self).__init__()
        self.conv1 = builder.conv3x3(in_planes, channels_1, stride=stride)
        self.bn1 = builder.batchnorm(channels_1)
        self.conv2 = builder.conv3x3(channels_1, planes)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, builder, in_planes, planes, channels_1, channels_2, stride=1):
        ...
        self.bn2 = builder.batchnorm(channels_2)
